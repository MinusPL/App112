...
#pragma warning disable 1591
    public class TonieciePage : ContentPage
    {
        public TonieciePage()
        {
#pragma warning restore 1591
            ...
            Picker didJump = new Picker
            {
                Title = "Czy osoba dokonała skoku do wody?",
            ...
            didJump.SelectedIndexChanged += (sender, args) =>
            {
                if (didJump.SelectedIndex == 1)
                    throw new NotImplementedException(); //TODO: przeniesienie na stronę z Urazem Kręgosłupa
            };
